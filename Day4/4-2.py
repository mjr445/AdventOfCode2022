...
def main():
    ...
    with open(argv[1], 'r', encoding='utf8') as input_file:
        for line in input_file.readlines():
            ...
            if lower_limit2 <= lower_limit1 <= upper_limit2 or \
                lower_limit2 <= upper_limit1 <= upper_limit2 or \
                lower_limit1 <= lower_limit2 <= upper_limit1 or \
                lower_limit1 <= upper_limit2 <= upper_limit1:
                overlapping_pairs += 1
